        ...
        70656: function(e, t, n) {
            ...
            async function el(e, t, n) {
                ...
                let d = "credentials" === c[e].type,
                    ...
                    f = await eo(),
                    p = await fetch("".concat(v, "?").concat(new URLSearchParams(n)), {
                        method: "post",
                        headers: {
                    ...
                    h = await p.json();
                if (o || !(d || u)) {
                    let e = null !== (r = h.url) && void 0 !== r ? r : i;
                    window.location.href = e, e.includes("#") && window.location.reload();
                    return
                }
                let w = new URL(h.url).searchParams.get("error"),
                    y = new URL(h.url).searchParams.get("code");
                return p.ok && await Y._getSession({
                    event: "storage"
                }), {
                    error: w,
                    code: y,
